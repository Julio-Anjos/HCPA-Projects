...
\legend{Fonte: \cite{li2009sequence}} \label{fig:sam} \end{figure}
...
\legend{Fonte: \cite{danecek2011variant}} \label{fig:vcf} \end{figure}
...
duas opções podem ser destacadas: processos ou \textit{threads}. Em suma, essas
...
levaram à seleção do sambamba para posterior avaliação.
...
\cite{byrd1988parallel}, é a prototipagem rápida de uma abordagem inicial para
